...
public class ClientIT {
    ...
    public static final String NEW_CLIENT_NAME = "CLIENTE 5";
    public static final String EXITS_CLIENT_NAME = "Cliente 1";
    ...
    @Test
    public void saveOrModifyWithExistNameShouldConflict() {

        ClientDto dto = new ClientDto();
        dto.setName(EXITS_CLIENT_NAME);
        ...
        response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + MODIFY_CLIENT_ID, HttpMethod.PUT,
                new HttpEntity<>(dto), Void.class);
        assertEquals(HttpStatus.CONFLICT, response.getStatusCode());
